...
<body>
    <div class="box2">
        <div class="box">
            <form class="form" method="post" action="../DataManager/ContactsManager.php">
                    <div class="center">
                        <h1>Création Contacts</h1>
                    </div>
                       <label for="firstname">Prénom</label>
                        ...
                        <div class="center">
                            <button type="submit" class="btn btn-info" name="submit">Créer un Contacts</button>
                        </div>
            </form>
        </div>
    </div>
